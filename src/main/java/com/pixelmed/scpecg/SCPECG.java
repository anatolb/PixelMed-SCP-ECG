...
public class SCPECG {
	...
	private static class ReferenceBeatSubtractionZone {
		private final int numberOfReferenceBeatSubtractionZones;
...
//System.err.println("In the ReferenceBeatSubtractionZone "+sample);
					return (int)(sample - start[qrs] + offsetToAlignFiducial);
				}
			}
			return -1;
		}
	...
	private static class ProtectedArea {
		private final int numberOfProtectedAreas;
		private final long[] start;
		private final long[] end;
	...
	private void decompressRhythmData() {
		...
		ArrayList<HuffmanTable> huffmanTablesList = section2 == null ? null : section2.getHuffmanTables();
...
//System.err.println("useNumberOfSamples = "+useNumberOfSamples);
			try {
                assert compressedLeadData != null;
...
//System.err.println("Decoder status after all samples done "+decoder.toString());
	...
	private void decompressReferenceBeatData() {
		Section3 section3 = (Section3)(sections.get(3));
		int       numberOfLeads = section3 == null ?    0 : section3.getNumberOfLeads();
		
		Section2 section2 = (Section2)(sections.get(2));
		int   numberOfHuffmanTables = section2 == null ?    0 : section2.getNumberOfHuffmanTables();
		ArrayList<HuffmanTable> huffmanTablesList = section2 == null ? null : section2.getHuffmanTables();
		
		Section4 section4 = (Section4)(sections.get(4));
		int lengthOfReferenceBeat0DataInMilliSeconds = section4 == null ?    0 : section4.getLengthOfReferenceBeat0DataInMilliSeconds();
		
		Section5Or6 section5 = (Section5Or6)(sections.get(5));
		if (section5 == null) {
			return;
		}
...
//System.err.println("[Byte offset = "+byteOffset+" dec (0x"+Long.toHexString(byteOffset)+")]");
			...
			sections.put(sectionHeader.getSectionIDNumber(),section);
		}
		Section0 section0 = (Section0)(sections.get(0));
	...
	public String toString() {
		...
		if (section3 == null) {
			...
			strbuf.append("Number of Leads = ").append(section3.getNumberOfLeads()).append("\n");
			strbuf.append(section3.getReferenceBeatUsedForCompression() ? "Reference Beat Used For Compression" : "Reference Beat Not Used For Compression").append("\n");
			strbuf.append(section3.getLeadsAllSimultaneouslyRecorded() ? "Leads All Simultaneously Recorded" : "Leads Not All Simultaneously Recorded").append("\n");
			strbuf.append("Number of Simultaneously Recorded Leads = ").append(section3.getNumberOfSimultaneouslyRecordedLeads()).append("\n");
		}
		...
		if (section4 == null) {
			...
			strbuf.append("Length ofReference Beat 0 Data In MilliSeconds = ").append(section4.getLengthOfReferenceBeat0DataInMilliSeconds()).append("\n");
			strbuf.append("Sample Number ofQRS of Fiducial = ").append(section4.getSampleNumberOfQRSOfFiducial()).append("\n");
			strbuf.append("Total Number of QRS Complexes = ").append(section4.getTotalNumberOfQRSComplexes()).append("\n");
		}
	...
	public Section1 getSection1()      { return     (Section1)(sections.get(1)); }
	public Section2 getSection2()      { return     (Section2)(sections.get(2)); }
	public Section3 getSection3()      { return     (Section3)(sections.get(3)); }
	public Section4 getSection4()      { return     (Section4)(sections.get(4)); }
	public Section5Or6 getSection5()   { return  (Section5Or6)(sections.get(5)); }
	public Section5Or6 getSection6()   { return  (Section5Or6)(sections.get(6)); }
	public Section7 getSection7()      { return     (Section7)(sections.get(7)); }
	public Section8Or11 getSection8()  { return (Section8Or11)(sections.get(8)); }
	public Section10 getSection10()    { return    (Section10)(sections.get(10)); }
	public Section8Or11 getSection11() { return (Section8Or11)(sections.get(11)); }
	 ...
	 *
	 * @return		an iterator of objects of type {@link Section Section}
	 */
	public Iterator<Section> getSectionIterator() { return sections == null ? null : sections.values().iterator(); }
	...
	public static void main(String[] arg) {
		...
		if(arg.length == 0) {
			arg = new String[3];
			arg[0] = "82DyKHdRdr.scp";
			arg[1] = "82DyKHdRdr1.txt";
			arg[2] = "82DyKHdRdr2.txt";
		}
		...
		try {			
			...
			SCPECG scpecg = new SCPECG(i,verbose);
			String json = new JSONObject(scpecg).toString(4);
			String str = scpecg.toString();
