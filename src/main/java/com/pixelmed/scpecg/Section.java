...
public class Section {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/scpecg/Section.java,v 1.14 2005/09/27 15:28:42 dclunie Exp $";
	...
	public static Section makeSection(SectionHeader sectionHeader,TreeMap sections) {
		...
		switch (sectionHeader.getSectionIDNumber()) {
			...
			case 5:
			case 6:		{
						Section3 section3 = (Section3)(sections.get(Integer.valueOf(3)));
