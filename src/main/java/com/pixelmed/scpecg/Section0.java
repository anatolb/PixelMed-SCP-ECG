...
public class Section0 extends Section {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/scpecg/Section0.java,v 1.7 2004/01/25 03:47:20 dclunie Exp $";
	...
	public String validateAgainstOtherSections(TreeMap sections) {
		...
		if (sectionIDNumbers != null) {
			for (int section=0; section<sectionIDNumbers.length; ++section) {
				Section targetSection = (Section)(sections.get(Integer.valueOf(sectionIDNumbers[section])));
