...
public class Section2 extends Section {
	...
	private ArrayList<HuffmanTable> huffmanTablesList;		// of class HuffmanTable
	...
	public ArrayList<HuffmanTable> getHuffmanTables() { return huffmanTablesList; }
	...
	public long read(BinaryInputStream i) throws IOException {
		...
		while (sectionBytesRemaining > 0) {
			...
			if (huffmanTablesList == null) {
				huffmanTablesList = new ArrayList<HuffmanTable>();
			}
	...
	public String toString() {
		...
		strbuf.append("Number of Huffman Tables = ").append(numberOfHuffmanTables).append(" dec (0x").append(Integer.toHexString(numberOfHuffmanTables)).append(")");
		strbuf.append(useDefaultTable() ? " DEFAULT" : "").append("\n");
		if (huffmanTablesList != null) {
			ListIterator<HuffmanTable> i = huffmanTablesList.listIterator();
			while (i.hasNext()) {
				strbuf.append("Table Number = ").append(i.nextIndex()).append("\n");
